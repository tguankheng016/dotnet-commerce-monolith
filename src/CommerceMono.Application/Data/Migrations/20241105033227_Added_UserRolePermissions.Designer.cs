...
namespace CommerceMono.Application.Data.Migrations
{
    ...
    [Migration("20241105033227_Added_UserRolePermissions")]
    partial class Added_UserRolePermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommerceMono.Application.Users.Models.UserRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CommerceMono.Application.Users.Models.UserRolePermission", b =>
                {
                    b.HasOne("CommerceMono.Application.Roles.Models.Role", "RoleFK")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .HasConstraintName("fk_user_role_permissions_roles_role_id");

                    b.HasOne("CommerceMono.Application.Users.Models.User", "UserFK")
                        .WithMany()
                        .HasForeignKey("UserId")
